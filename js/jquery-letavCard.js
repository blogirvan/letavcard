...
+"go'><img src='http://2.bp.blogspot.com/-yUgHT0ChtGI/U4Fpmt2j85I/AAAAAAAABjQ/17yERqqsik4/s1600/BIE_logo+leta.png'/></a>");
        ...
        function initGmap() {
            ...
            $('#map').gmap3({
                ...
                marker: {
                    ...
                    options: {
                        draggable: false,
                        icon: 'http://3.bp.blogspot.com/-MsAIlHzumHQ/VLoM9bMm-gI/AAAAAAAACmc/XN1X27Btk5w/s1600/gmap_marker.png'
                    }
                }
            });
        }
